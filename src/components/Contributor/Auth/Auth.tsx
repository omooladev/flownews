  ...
  return (
    <>
      <PopUp onClick={closePopUpHandler} className={`${styles.auth}`}>
        ...
        {forgotPasswordLocation && <ForgotPassword authReply={authReply} onChangeAuthReply={changeAuthReply} onResetAuthReply={resetAuthReply} onValidateEmail={validateEmailHandler} />}
