...
const Login = (props) => {
  useTitle('Login');
  const { passwordChanged, viewPassword, toggleViewPasswordHandler, authReply, onChangeAuthReply, onResetAuthReply, onValidateEmail, onValidatePassword } = props;
  const { changeAppMode, onLoginOrBecomeContributor, history, onSaveContributorData, onMakeBodyFixed } = useContext(AuthContext);
  ...
  const loginHandler = useCallback(
    ...
    [history, changeAppMode, onValidateEmail, onValidatePassword, onChangeAuthReply, onResetAuthReply, onSaveContributorData, onLoginOrBecomeContributor, onMakeBodyFixed],
  );
      ...
      <form className={styles.form} onSubmit={loginHandler}>
        ...
        <div className={styles.form_control}>
          ...
          <div className={styles.input_container}>
            ...
            {!viewPassword && <FaEyeSlash className={styles.password_icon} onClick={toggleViewPasswordHandler} />}
