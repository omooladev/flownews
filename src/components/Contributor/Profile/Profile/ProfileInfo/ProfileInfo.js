...
const ProfileInfo = (props) => {
  ...
  return (
    <section className={`${styles['contributor_info']} ${className}`}>
      <ProfileName data={searchedContributorExist ? searchedContributorData : contributorData} source={source} />
      ...
      <div className={styles.contributor_location_email_joinedDate}>
        <ProfileLocation location={searchedContributorExist ? searchedContributorData.location : contributorData.location} />
        <ProfileDate createdAt={searchedContributorExist ? searchedContributorData.createdAt : contributorData.createdAt} />
        {((searchedContributorExist && !searchedContributorData.emailIsPrivate) || !searchedContributorExist) && (
          <ProfileEmail
            email={searchedContributorExist ? searchedContributorData.email : contributorData.email}
            emailIsVerified={searchedContributorExist ? searchedContributorData.emailIsVerified : contributorData.emailIsVerified}
          />
        )}
      </div>
      ...
      />
      <ProfileMoreInfo username={searchedContributorExist ? searchedContributorData.username : contributorData.username} />
    </section>
  );
};
